#!/usr/bin/env python3
"""Build the Indonesian pack with the shared builder in vocab-engine.
...
engine/tools/packbuilder/langs/id.py (Indonesian rules). This repo keeps only the
...
if __name__ == "__main__":
    sys.exit(main(["build", "--lang", "id", "--repo", str(ROOT)] + sys.argv[1:]))
